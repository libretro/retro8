...
# Nintendo WiiU
	...
	CFLAGS += -DGEKKO -DWIIU -DHW_RVL -mcpu=750 -meabi -mhard-float
        CFLAGS += -ffunction-sections -fdata-sections -D__wiiu__ -D__wut__ -DHW_WUP
	CXXFLAGS += -DGEKKO -DWIIU -DHW_RVL -mcpu=750 -meabi -mhard-float
	CXXFLAGS += -ffunction-sections -fdata-sections -D__wiiu__ -D__wut__ -DHW_WUP
	HAVE_RZLIB := 1
	STATIC_LINKING=1
